<%@ Page Title="" Language="C#" MasterPageFile="~/mpPrincipal.master" AutoEventWireup="true" CodeFile="Usuarios.aspx.cs" Inherits="Default2" %>
...
&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td width="80%">
                        ...
                        <asp:Label ID="Label7" runat="server" Text="Usuarios registrados" Font-Bold="True" Font-Names="Arial" Font-Size="Medium" ForeColor="Black"></asp:Label>
